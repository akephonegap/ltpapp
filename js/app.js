	...
	*/
	...
	$scope.register = function() {
		...
		if (ionic.Platform.isAndroid()) {
			config = {
				"senderID" : "798065325698" // REPLACE THIS WITH YOURS FROM GCM CONSOLE - also in the project URL like: https://console.developers.google.com/project/434205989073
			};
	...
	function removeDeviceToken() {
		...
		$http.post('http://192.168.1.16:8000/unsubscribe', JSON.stringify(tkn)).success(function(data, status) {
